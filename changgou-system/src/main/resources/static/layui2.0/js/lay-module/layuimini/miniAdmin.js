...
layui.define(["jquery", "miniMenu", "element", "miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            $.ajax({
                ...
                beforeSend: function (request) {
                    request.setRequestHeader("authorization", layui.data('LocalData')["access_token"]);
                },
                success: function (res) {
                    top.layer.close(loadIndex);
                    if (res == null || res.data == null || res.data.menuInfo == null) {
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src="' + data.href + '?timestamp=' + new Date().getTime() + '"></iframe>');
        },
